...
const Skills: FC<SkillsProps> = ({ slice }) => {
  ...
  return (
    <section
      ...
      className=" bg-primary/95 py-20 shadow shadow-amber-50"
    >
      <Container>
        <div className="container mx-auto text-center">
          <h2 className="text-5xl font-bold mb-10 text-textPrimary">Skills</h2>
          <div>
            <h3 className="text-xl text-textSecondary md:text-2xl font-semibold my-5">Frontend</h3>
              ...
              {!!data.frontend_skills &&
                data.frontend_skills.map((item) => (
                  ...
                  >
                    ...
                    />
                    <p className="text-textTertiary font-semibold">{item.title}</p>
                  </div>
                ))}
            </div>
          </div>
          <div>
            <h3 className="text-xl text-textSecondary md:text-2xl font-semibold my-5">Styling & UI</h3>
            <div className="flex flex-wrap gap-8">
              {!!data.styling_ui &&
          ...
          <div>
            <h3 className="text-xl text-textSecondary md:text-2xl font-semibold my-5">Tools & Workflow</h3>
            <div className="flex flex-wrap gap-8">
              {!!data.tools_workflow &&
